...
const int DEBUG = 0;	
const int STAS = 1;		
int ONLY_COMPUTE_NEW_PROTEIN = 0; 
...
int num_protein = 0; 
uint64_t hash_table_default = 1090715534754863;	
...
boost::unordered_map <int, string> p_id_seq; 
...
inline int compare_two_strings(int p1_id, int p2_id, int sta_1, int sta_2, int len){	
	int score = 0;
...
void assign_matrix(int M[23][23], int value[23][23]){	
	for(int a = 0; a < 23; a ++){
		for(int b = 0; b < 23; b ++){
			M[a][b] = value[a][b];
		}
