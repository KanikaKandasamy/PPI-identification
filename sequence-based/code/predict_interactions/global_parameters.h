...
const int NPRO = 20117; 

int num_protein = 0;
int k_size = 20;
map <int, string> p_id_name;
map <string, int> p_name_id;
map <int, string> p_id_seq; 
const int BLOSUM80[23][23] =	//it's acutally PAM120, the last row and column indicate "X"
    {
...
inline int compare_two_strings(string str1, string str2){	
	int score = 0;
